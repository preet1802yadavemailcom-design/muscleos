...
import { Users, UserCheck, DollarSign, TrendingUp, Download } from 'lucide-react';
...
interface DashboardStats {
  members: { total: number; active: number; inactive: number; expired: number };
  attendance: { checkInsToday: number; currentlyInGym: number };
  batches: { total: number; active: number };
  revenue: { total: number; today: number; pendingPayments: number };
}
