...
export const navigation: NavItem[] = [
  ...
  { name: 'Members', href: '/members', icon: Users, roles: ['GYM_OWNER', 'TRAINER', 'RECEPTIONIST'] },
  { name: 'Batches', href: '/batches', icon: Calendar, roles: ['GYM_OWNER', 'TRAINER'] },
  { name: 'Attendance', href: '/attendance', icon: QrCode, roles: ['GYM_OWNER', 'TRAINER', 'RECEPTIONIST', 'MEMBER'] },
  { name: 'Memberships', href: '/memberships', icon: RefreshCcw, roles: ['GYM_OWNER', 'RECEPTIONIST'] },
  { name: 'Payments', href: '/payments', icon: CreditCard, roles: ['GYM_OWNER', 'RECEPTIONIST'] },
  { name: 'Pending UPI', href: '/payments/pending-upi', icon: Wallet, roles: ['GYM_OWNER', 'RECEPTIONIST'] },
  { name: 'Reports', href: '/reports', icon: BarChart3, roles: ['GYM_OWNER'] },
  { name: 'Notifications', href: '/notifications', icon: Bell, roles: ['GYM_OWNER'] },
  { name: 'Support', href: '/support', icon: LifeBuoy, roles: ['GYM_OWNER', 'TRAINER', 'RECEPTIONIST', 'MEMBER'] },
  { name: 'Assign Fitness Plan', href: '/fitness/assign', icon: Dumbbell, roles: ['GYM_OWNER', 'TRAINER'] },
  { name: 'Settings', href: '/settings', icon: Settings, roles: ['GYM_OWNER'] },
