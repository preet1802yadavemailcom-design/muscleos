...
export class SuperAdminController {
  ...
  @ApiOperation({ summary: 'Suspend an active gym (requires step-up re-auth — see POST /auth/step-up/verify)' })
  ...
  @Delete('gyms/:id')
  @UseGuards(StepUpGuard)
  @ApiOperation({ summary: 'Soft-delete a gym from the platform (requires step-up re-auth)' })
