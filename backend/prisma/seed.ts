...
async function seedNotificationTemplates() {
  const templates = [
    ...
    },
    {
      ...
      body: 'Hi {{memberName}}, your account is verified and ready. Open the MuscleOS app to view your membership and scan in at the gym.',
    ...
    },
    {
      ...
      body: 'Hi {{memberName}}, your {{planName}} membership is now active, valid until {{endDate}}. See you at the gym!',
      variables: ['memberName', 'planName', 'endDate'],
    },
    {
      name: 'membership_renewed',
      type: NotificationType.SYSTEM,
      channel: NotificationChannel.EMAIL,
      subject: 'Membership renewed — {{planName}}',
      body: 'Hi {{memberName}}, your {{planName}} membership has been renewed and is now valid until {{endDate}}. Thanks for staying with us!',
      variables: ['memberName', 'planName', 'endDate'],
    },
  ];
