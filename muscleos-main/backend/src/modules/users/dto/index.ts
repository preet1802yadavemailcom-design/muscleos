...
export class CreateStaffDto {
  ...
  @ApiPropertyOptional({ description: 'Restrict this staff member to one branch; omit for gym-wide access' })
  @IsOptional() @IsString()
  branchId?: string;
}
...
export class UpdateStaffDto {
  ...
  @ApiPropertyOptional({ description: 'Reassign branch access, or set null for gym-wide access' })
  @IsOptional() @IsString()
  branchId?: string;
}
